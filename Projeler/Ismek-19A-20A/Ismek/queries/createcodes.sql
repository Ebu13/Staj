...
-- Kullanýcý Eðitimleri Tablosu (Güncellenmiþ)
CREATE TABLE KullaniciEgitimleri (
    ...
    egitim_durumu VARCHAR(50) NULL, -- Devam Eden, Bitmiþ, Hiç Baþlanmamýþ
    FOREIGN KEY (kullanici_id) REFERENCES Kullanicilar(kullanici_id),
    FOREIGN KEY (egitim_id) REFERENCES Egitimler(egitim_id)
);
GO

-- Kullanýcý Eðitim Durumu Tetikleyicisi
...
BEGIN
    ...
    SET egitim_durumu = 
        CASE
            ...
            ELSE 'Unknown' -- Eðer farklý bir durum oluþursa (güvenlik için)
        END
